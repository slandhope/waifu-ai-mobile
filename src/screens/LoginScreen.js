...
GoogleSignin.configure({
  ...
  // webClientId is REQUIRED to get an idToken back on Android; on iOS the
  // iosClientId is enough. Fill this in if/when you add Android.
    ...
    <View style={{ flex: 1 }}>
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.logoSection}>
          ...
          <Text style={styles.tagline}>Your daily companion & clarity coach</Text>
        </View>
